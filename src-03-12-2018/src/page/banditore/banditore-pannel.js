        ...
        <Row>
            ...
            <Panel title="Pagina dove vengono visualizzate tutte le funzioni relative al Banditore">
              ...
              <div className ="Titolo del bando">
                <Panel title="Ultimi bandi Aggiunti">
                  ...
                  <div>
                    <BootstrapTable className="bordered" options={ options }  data={ AllBandi }>
                      ...
                      <TableHeaderColumn className="black-muted-bg" dataField='DataCreazione' filter={ { type: 'TextFilter', delay: 1000 }} dataAlign='center' dataSort={ true }>CREATO IL</TableHeaderColumn>
                      ...
                      <TableHeaderColumn className="black-muted-bg" dataField={this.renderRating(this.state.allBandi.MinRating)} filter={ { type: 'TextFilter', delay: 1000 }} dataAlign='center' dataSort={ true }>PUNTEGGIO MIN</TableHeaderColumn>
          ...
          <Tab title = "ALBO FORNITORI">
            <Panel title='Tabella Fornitori'>
              <div>
                <BootstrapTable className="bordered" options={ options2 }  data={ dataB }>
                  <TableHeaderColumn className="black-muted-bg" dataField='ID' editable={false} width='90' isKey={true} dataSort={ true } dataAlign='center'>ID</TableHeaderColumn>
                  ...
                  <TableHeaderColumn className="black-muted-bg" dataField='NomeBando' filter={ { type: 'TextFilter', delay: 1000 }} dataAlign='center' dataSort={ true }>NOME DEL BANDO</TableHeaderColumn>
                  ...
                  <TableHeaderColumn className="black-muted-bg" dataField='Rating' filter={ { type: 'TextFilter', delay: 1000 }} dataAlign='center' dataSort={ true }>RATING MEDIO</TableHeaderColumn>
                </BootstrapTable>
              </div>
            </Panel>
          </Tab>
